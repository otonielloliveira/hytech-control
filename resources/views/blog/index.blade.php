            ...
            <div class="container-fluid">
                    ...
                    @foreach ($featuredProducts as $product)
                        <div class="col-lg-4 col-md-6">
                            <div class="card product-card h-100 border-0 shadow"
                                style="border-radius: 12px; overflow: hidden; transform: translateY(0); transition: all 0.3s ease; max-width: 100%;">
                                ...
                                <div class="card-body d-flex flex-column p-3">
                                    <h6 class="card-title fw-bold text-dark mb-2"
                                        style="font-size: 1rem; line-height: 1.3;">{{ $product->name }}</h6>
                                    ...
                                    <div class="mt-auto">
                                        ...
                                        <div class="d-grid gap-1">
                                            @if ($product->in_stock)
                                                <button
                                                    class="btn btn-primary btn-sm rounded-pill fw-semibold add-to-cart-homepage"
                ...
                @if ($featuredProducts->count() > 3)
                    <div class="text-center">
                        <a href="{{ route('store.index') }}" class="btn btn-light btn-lg rounded-pill px-5 py-3 fw-bold">
