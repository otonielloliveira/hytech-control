                        ...
                        <div class="px-6 py-4">
                            @if ($order->billing_address)
                                ...
                                <address class="text-sm text-gray-600 not-italic">
                                    ...
                                    {{ $billing['city'] ?? 'N/A' }}, {{ $billing['state'] ?? 'N/A' }}
                                    {{ $billing['zip'] ?? '' }}<br>
                            ...
                            <div class="bg-blue-50 border border-blue-200 rounded-lg p-4">
                                <div class="flex items-center">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-xl font-mono font-bold text-blue-900">{{ $order->tracking_code }}
                                        </p>
                        ...
                        <div class="space-y-2">
                            ...
                            @if ($order->payment_transaction_id)
                                <div class="flex justify-between text-sm">
                                    ...
                                    <span
                                        class="font-mono text-xs">{{ Str::limit($order->payment_transaction_id, 15) }}</span>
                                </div>
                            @endif
                        </div>
                    </div>
