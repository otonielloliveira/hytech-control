...
<div class="hero-carousel">
    <div class="carousel-item active" style="background-image: linear-gradient(135deg, #667eea 0%, #764ba2 100%);">
        <div class="carousel-overlay">
            <div class="container">
                <div class="carousel-content">
                    <h1><i class="{{ $download->icon_class }} me-3"></i>{{ $download->title }}</h1>
                    <h2>Download de Arquivo</h2>
                    <p>{{ $download->description ?: 'Baixe este arquivo exclusivo.' }}</p>
                </div>
            </div>
        </div>
    </div>
