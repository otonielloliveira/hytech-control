                        ...
                        <form action="{{ route('donations.store') }}" method="POST" id="donationForm">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12 mb-3">
                                    ...
                                    <input type="number" class="form-control @error('amount') is-invalid @enderror"
                                        id="amount" name="amount" value="{{ old('amount') }}" min="1"
                                        max="10000" step="0.01" placeholder="Ex: 25.00" required>
                                    @error('amount')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="d-flex flex-wrap gap-2">
                                    <button type="button" class="btn btn-outline-success btn-sm amount-suggestion"
                                        data-amount="10">R$ 10</button>
                                    <button type="button" class="btn btn-outline-success btn-sm amount-suggestion"
                                        data-amount="25">R$ 25</button>
                                    <button type="button" class="btn btn-outline-success btn-sm amount-suggestion"
                                        data-amount="50">R$ 50</button>
                                    <button type="button" class="btn btn-outline-success btn-sm amount-suggestion"
                                        data-amount="100">R$ 100</button>
                                    <button type="button" class="btn btn-outline-success btn-sm amount-suggestion"
                                        data-amount="250">R$ 250</button>
                                </div>
                            </div>
